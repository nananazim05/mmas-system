                        ...
                        @for ($day = 1; $day <= $daysInMonth; $day++)
                            ...
                            <div class="p-2 rounded relative group {{ $isToday ? 'bg-green-100 text-green-800 font-bold' : 'hover:bg-gray-100' }} {{ $hasMeeting ? 'border-2 border-red-500 font-bold text-red-600 cursor-pointer' : '' }}">
                                ...
                                @if($hasMeeting) 
                                    ...
                                    <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 w-[300px] min-w-[250px] bg-white text-left text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-all duration-200 z-50 pointer-events-none shadow-xl border border-gray-200">
